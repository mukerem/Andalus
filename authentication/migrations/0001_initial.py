# Generated by Django 2.0.7 on 2019-06-28 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campus', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='authentication.Campus')),
                ('member', models.ManyToManyField(limit_choices_to={'category__category': 'Participant', 'role__role': 'Team Member'}, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='activeteam',
            name='user',
            field=models.OneToOneField(limit_choices_to={'category__category': 'Participant', 'role__role': 'Team Member'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='campus',
